...
- [Operations and Runbooks](./operations/index.md)
  - [Authentication and Authorization](./operations/auth.md)
  - [Add Advertisers](./operations/addAdvertisers.md)
  - [Add Advertiser Paths](./operations/addAdvertiserPaths.md)
  - [Add Partners](./operations/addPartners.md)
  - [Create SOV Allocations](./operations/createSovAllocations.md)
