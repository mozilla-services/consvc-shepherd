...
A PR template is generated every time you open a new PR, so make sure to fill out the required fields, follow the format and supply sufficient context to potential reviewers. The template can be found [here](https://github.com/mozilla-services/consvc-shepherd/blob/main/PULL_REQUEST_TEMPLATE.md).
